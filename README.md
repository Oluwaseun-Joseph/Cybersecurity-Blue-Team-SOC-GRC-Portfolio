<h1>Hi, I’m Oluwaseun (’Seun)</h1>

<h3>Cybersecurity | Blue Team | SOC, IAM & GRC</h3>

I build hands-on cybersecurity projects focused on **security operations, identity and
access management, and governance, risk, and compliance**.

My work emphasizes **accurate analysis, evidence-backed findings, and clear documentation**
that reflects how security teams operate in real environments.
...
- **[Project 02 – Wireshark HTTP Traffic Analysis](https://github.com/Oluwaseun-Joseph/Cybersecurity-Blue-Team-SOC-GRC-Portfolio/tree/main/Project-02-Wireshark-HTTP-Analysis)**  
  Application-layer traffic inspection for defensive and forensic analysis.

- **[Project 03 – Wireshark TCP Analysis](https://github.com/Oluwaseun-Joseph/Cybersecurity-Blue-Team-SOC-GRC-Portfolio/tree/main/Project-03-Wireshark-TCP-Analysis)**  
  Connection behavior, retransmissions, and protocol-level investigation.
...
- **[Project 06 – Wireshark DNS Analysis](https://github.com/Oluwaseun-Joseph/Cybersecurity-Blue-Team-SOC-GRC-Portfolio/tree/main/Project-06-Wireshark-DNS-Analysis)**  
  DNS query/response behavior and resolution dependencies.

- **[Project 07 – Microsoft Entra ID IAM Audit (Privileged Access Review)](https://github.com/Oluwaseun-Joseph/Cybersecurity-Blue-Team-SOC-GRC-Portfolio/tree/main/Project-07-EntraID-IAM-Audit)**  
  IAM audit covering Global Administrator exposure, break-glass access, RBAC design,
  exported role evidence, and documented governance limitations using an audit-style
  evidence index.
...
- SOC investigations and network traffic analysis  
...
[GitHub](https://github.com/Oluwaseun-Joseph)
